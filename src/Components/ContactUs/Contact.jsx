      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-6 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <a href="mailto:scade.magmist@gmail.com" className="text-cyan-600 hover:underline">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <a href="tel:+917411532800" className="text-cyan-600 hover:underline">
              +91 74115 32800
            </a>
          </div>
          <div className="flex flex-col items-center md:items-start">
