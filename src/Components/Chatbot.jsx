...
const predefinedResponses = {
    ...
    team:
      "SCADE is a family‑driven startup. Dr. Chinmai V S (MD), Deekshi P (Tech Head), Samartha V S (Marketing), and our two family pillars manage finance & ethics. Meet the whole team on the Team page.",
    order:
...
const WHATSAPP_PREFILL = encodeURIComponent("Hi SCADE, I'm reaching out from the website chatbot. I'd like to chat with a human.");
                    ...
                    >
                        ...
                        >
                            <input
                                ...
                                className="flex-1 px-4 py-2 rounded-full bg-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400"
                                autoFocus
                            />
                            <button
                                type="submit"
